...
class RegularConan(ConanFile):
    name = "regular_c"
    version = "1.0.0"
    requires = ["dictionary_c/1.0.0", "data_structure_c/1.0.0", "util_c/1.0.0"]
    license = "GPL License"
    author = "Olcay Taner Yildiz olcay.yildiz@ozyegin.edu.tr"
    url = "https://github.com/StarlangSoftware/Regular-C"
    description = "Regular Languages Library"
    topics = ("")
